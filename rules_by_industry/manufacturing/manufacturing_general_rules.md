# Manufacturing Industry General Registration & Compliance Rules

**Industry**: Manufacturing  
**Sector**: Industrial Production  
**Subsector**: General Manufacturing  

Core incorporation, GST, labour, and baseline registration rules required for setting up manufacturing businesses in India.
...
### Rule 12: Pollution Control Board Consent to Establish / Operate (MPCB)
...
**Subsector**: General Manufacturing  
**Applicable to**: private_limited_company  
**Condition**: IF industry_or_sector equals manufacturing AND state equals Maharashtra  
**Mandatory**: needs_review | **Conditional**: true  
**Status**: `needs_review` ⚠️ *(Requires Legal/Officer Review)*  

**Description**:  
Manufacturing entities generating trade effluent or air emissions must obtain Consent to Establish prior to plant construction and Consent to Operate prior to commercial production under Water and Air Acts.

**Required Documents**:  
  - Manufacturing Process Flowchart
  - Plant & Machinery Details
  - Water Consumption & Effluent Balance
  - Plot Layout Plan

**Accepted Alternatives**:  
  - MAITRI Single Window Combined Application Form

**Required Forms**:  
  - MPCB Consent Application (MAITRI / MPCB Portal)
...
### Rule 13: Factory License under Factories Act, 1948 (DISH Maharashtra)
...
**Subsector**: General Manufacturing  
**Applicable to**: private_limited_company  
**Condition**: IF industry_or_sector equals manufacturing AND employee_count greater_than 9 AND uses_power equals true  
**Mandatory**: needs_review | **Conditional**: true  
**Status**: `needs_review` ⚠️ *(Requires Legal/Officer Review)*  

**Description**:  
Factories employing 10 or more workers with power or 20 or more workers without power must obtain Factory Building Plan Approval and Factory License from Directorate of Industrial Safety and Health (DISH).

**Required Documents**:  
  - Factory Plan Approval Drawing
  - Machinery Safety Certificate
...
**Required Forms**:  
  - DISH Form 1 & Form 2 Factory License Application
...
### Rule 14: DPIIT Startup Recognition Certificate & Eligibility
...
### Rule 15: Maharashtra Shops and Establishments Registration Certificate (Form A)
...
### Rule 16: Maharashtra Shops Intimation Receipt (Form F - Gumasta)
...
- **Maharashtra Industry Trade and Investment Facilitation Cell (MAITRI) Act & Portal Guidelines**: [Official Government Source](https://industry.maharashtra.gov.in/en/allied-offices/maharashtra-industry-trade-and-investment-facilitation-cell-maitri) (MAITRI Act 2016 - Schedule I Industrial Approvals)
