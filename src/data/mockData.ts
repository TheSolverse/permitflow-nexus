...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    email: 'gst.approval@mahatax.gov.in',
    role: 'OFFICER_GST',
    department: 'State Tax Department',
    phone: '+91 022 2288 1234',
  },
  {
    id: 'usr-13',
    name: 'Director N. K. Verma',
    email: 'udyam.desk@msme.gov.in',
    role: 'OFFICER_MSME',
    department: 'Ministry of MSME',
    phone: '+91 011 2306 2211',
  },
  {
    id: 'usr-14',
    name: 'Officer Subhash Patil',
    email: 'ptax.officer@mahatax.gov.in',
    role: 'OFFICER_PTAX',
    department: 'State Tax Department',
    phone: '+91 022 2288 5678',
  },
  {
    id: 'usr-9',
...
export const INITIAL_PARALLEL_PERMISSIONS: ParallelPermissionItem[] = [
  {
    ...
    projectId: 'proj-1',
    approvalId: 'appr-8',
    approvalName: 'MPCB Consent to Establish (CTE NOC)',
    department: 'Maharashtra Pollution Control Board (MPCB)',
    category: 'Environmental',
    assignedOfficer: 'Dr. V. K. Patil',
    officerEmail: 'vk.patil@mpcb.gov.in',
    status: 'Query Raised',
    pendingWith: 'Entrepreneur (Rahul Sharma)',
    pendingAction: 'Respond to ETP peak monsoon discharge query & flow meter specs',
    dateReceived: '2026-08-10',
    lastUpdatedDateTime: '2026-08-25, 11:20 AM',
    pendingDocs: ['Effluent Treatment Plant (ETP) Peak Flow Calculation Sheet'],
    documentIds: ['doc-6', 'doc-4'],
    queriesCount: 1,
    openQueries: [
      {
        id: 'q-noc-1',
        queryCategory: 'Technical ETP Specification',
        queryText: 'Please submit peak monsoon discharge calculation for Effluent Treatment Plant (ETP) along with flow meter specifications.',
        raisedDate: '2026-08-20',
        dueDate: '2026-09-01'
      }
    ],
    slaDeadlineDate: '2026-09-01',
    slaDaysRemaining: 4,
    dependencies: ['appr-1', 'appr-2'],
    submittedDate: '2026-08-10',
    lastUpdatedDate: '2026-08-25',
    remarks: 'Desk scrutiny complete. ETP monsoon capacity clarification needed before CTO stage.',
    activityHistory: [
      {
        id: 'act-1',
        ...
        notes: 'Submitted online CTE application with ETP design layout.'
      },
      {
        id: 'act-2',
        timestamp: '2026-08-25 11:20 AM',
        actor: 'Dr. V. K. Patil',
        department: 'MPCB Officer Desk',
        action: 'Query Raised',
        notes: 'Requested monsoon flow rate annexure.'
      }
    ]
  },
  {
    ...
    projectId: 'proj-1',
    approvalId: 'appr-6',
    approvalName: 'Fire Safety Provisional NOC',
    department: 'Maharashtra Fire Services',
    category: 'Safety',
    assignedOfficer: 'Officer Sunita Rane',
    officerEmail: 'sunita.rane@fireservices.maharashtra.gov.in',
    status: 'Under Review',
    pendingWith: 'Fire Officer (Sunita Rane)',
    pendingAction: 'Joint site verification & high-rise sprinkler test',
    dateReceived: '2026-08-15',
    lastUpdatedDateTime: '2026-08-24, 04:50 PM',
    pendingDocs: [],
    documentIds: ['doc-5'],
    queriesCount: 0,
    slaDeadlineDate: '2026-09-05',
    slaDaysRemaining: 8,
    dependencies: ['appr-5'],
    submittedDate: '2026-08-15',
    lastUpdatedDate: '2026-08-24',
    remarks: 'Provisional hydraulic calculations verified. Joint site inspection scheduled for Sep 2nd.',
    activityHistory: [
      {
        id: 'act-10',
        timestamp: '2026-08-15 02:30 PM',
        actor: 'Rahul Sharma',
        department: 'Entrepreneur',
        action: 'Application Submitted',
        notes: 'Submitted Provisional Fire NOC application with sprinkler CAD drawings.'
      },
      {
        id: 'act-11',
        timestamp: '2026-08-24 04:50 PM',
        actor: 'Officer Sunita Rane',
        department: 'Fire Officer Desk',
        action: 'Inspection Scheduled',
        notes: 'Fixed joint inspection date with MPCB and DISH officers.'
      }
    ]
  },
  {
    ...
    pendingWith: 'DISH Inspector (A. B. Kadam)',
    pendingAction: 'On-site machinery safety distance audit & worker roster check',
    dateReceived: '2026-08-12',
    lastUpdatedDateTime: '2026-08-24, 05:00 PM',
    pendingDocs: [],
    documentIds: ['doc-7', 'doc-9'],
    queriesCount: 0,
    slaDeadlineDate: '2026-09-08',
    slaDaysRemaining: 11,
    dependencies: ['appr-5', 'appr-6'],
    submittedDate: '2026-08-12',
    lastUpdatedDate: '2026-08-24',
    remarks: 'Structural stability certificate verified. Joint site audit confirmed.',
    activityHistory: [
      {
        id: 'act-20',
        ...
        department: 'Entrepreneur',
        action: 'Application Submitted',
        notes: 'Submitted DISH Form 1 layout plan and machinery roster.'
      }
    ]
  },
  {
    ...
    projectId: 'proj-1',
    approvalId: 'appr-10',
    approvalName: 'MSEDCL High Tension (HT) Electrical Power Sanction (100 kVA)',
    department: 'Maharashtra State Electricity Distribution Co Ltd (MSEDCL)',
    category: 'Utility',
    ...
    pendingAction: 'Download digital power sanction NOC & pay service connection deposit',
    dateReceived: '2026-07-28',
    lastUpdatedDateTime: '2026-08-18, 03:20 PM',
    pendingDocs: [],
    documentIds: ['doc-10', 'doc-11'],
    queriesCount: 0,
    slaDeadlineDate: '2026-08-18',
    slaDaysRemaining: 0,
    dependencies: ['appr-1'],
    submittedDate: '2026-07-28',
    lastUpdatedDate: '2026-08-18',
    remarks: 'High Tension load of 100 kVA sanctioned for Chakan MIDC Plot C-42.',
    certificateId: 'CERT-MSEDCL-2026-8891',
    certificateIssuedDate: '2026-08-18',
    certificateExpiryDate: '2031-08-18',
    certificateType: 'FINAL',
    certificateQrToken: 'MSEDCL-HT-APEX-8891',
    activityHistory: [
      {
        id: 'act-30',
        ...
        department: 'Entrepreneur',
        action: 'Application Submitted',
        notes: 'Submitted HT power connection request with SLD diagram.'
      },
      {
        id: 'act-31',
        timestamp: '2026-08-18 03:20 PM',
        actor: 'Er. R. N. Deshpande',
        department: 'MSEDCL Executive Engineer',
        action: 'Application Approved',
        notes: 'Sanctioned 100 kVA HT load and issued digital NOC certificate.'
      }
    ]
  },
  {
    ...
    projectId: 'proj-1',
    approvalId: 'appr-12',
    approvalName: 'FSSAI State Food Manufacturing Licence',
    department: 'FSSAI Food Safety Maharashtra',
    category: 'Registration',
    assignedOfficer: 'Officer Meena Thorat',
    officerEmail: 'm.thorat@fssai.gov.in',
    status: 'Under Review',
    pendingWith: 'FSSAI Food Safety Officer (Meena Thorat)',
    pendingAction: 'FoSCoS technical verification & hygiene audit checklist',
    dateReceived: '2026-08-18',
    lastUpdatedDateTime: '2026-08-22, 10:45 AM',
    pendingDocs: [],
    documentIds: ['doc-13', 'doc-14', 'doc-15', 'doc-16'],
    queriesCount: 0,
    slaDeadlineDate: '2026-09-12',
    slaDaysRemaining: 15,
    dependencies: ['appr-2', 'appr-8'],
    submittedDate: '2026-08-18',
    lastUpdatedDate: '2026-08-22',
    remarks: 'FSMS plan and water lab test report verified sound. Hygiene audit scheduled.',
    activityHistory: [
      {
        id: 'act-40',
        ...
        department: 'Entrepreneur',
        action: 'Application Submitted',
        notes: 'Submitted FoSCoS state manufacturing license application.'
      }
    ]
  }
];
